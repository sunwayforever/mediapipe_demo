...
# output_pb_path = "../../model/face_detection_front.pb"
output_savedmodel_path = "../../model/face_detection_front"
model_json_path = "../../model/face_detection_front.json"
num_tensors = 176
