...
const int BytesPerPixel[NUM_OF_PIXEL_FORMATS] = {1, 2, 2, 2, 2, 4, 3, 3, 6, 1, 2, 2, 8};
const int NibblesPerPixel[NUM_OF_PIXEL_FORMATS] = {2, 3, 4, 4, 4, 7, 6, 6, 12, 2, 4, 4, 16};

const std::string HexOutWidth[] = {"%x","%01x","%02x","%03x","%04x","%05x","%06x","%07x","%08x","%09x","%10x","%11x","%12x","%13x","%14x","%15x","%16x"};
...
typedef enum {
	UNKNOWN_TYPE = -1, 
	HD_1FPS, HD_10FPS, 
	FULLRES_1FPS, FULLRES_2FPS, FULLRES_3FPS, FULLRES_10FPS, 
	VGA_1FPS, VGA_3FPS, VGA_10FPS, VGA_20FPS, VGA_SYNTH_1FPS, VGA_SYNTH_10FPS, 
	QVGA_60FPS, 
	NUM_TABLE_PRESETS
} PresetTableType;
